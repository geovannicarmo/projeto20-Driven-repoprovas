...
CREATE TABLE "tests" (
    ...
    "teacherDisciplineldId" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_teacherDisciplineldId_fkey" FOREIGN KEY ("teacherDisciplineldId") REFERENCES "teachersDisciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
